      ...
      <div class="panel">
        ...
        <el-header>
          <el-form ref="form" :model="searchField">
            <el-button size='mini' type="primary" @click='editTableRow("dialogVisible", "dialogTitle", "rowData", "新增职务", {})'>添加</el-button>
          </el-form>
        </el-header>
        <!-- 工具栏 end -->
          ...
          <el-table :data="tableData" :max-height="tableHeigt" size='small' stripe border>
            <el-table-column label="操作" align="center" width="150">
              <template slot-scope="scope">
                <el-button size="mini" type="primary" @click="editTableRow('dialogVisible', 'dialogTitle', 'rowData', '编辑职务', scope.row)">编辑</el-button>
                <el-button size="mini" type="danger" @click="deleteTableRow('http://localhost/Gateway4CWGL/MinaMap_CWGLService.svc/DeleteAZWB', { id: scope.row.BH })">删除</el-button>
              </template>
            </el-table-column>
            <el-table-column prop="BH" label="编号" align="center"></el-table-column>
            <el-table-column prop="MC" label="职务" align="center"></el-table-column>
...
<script>
import EditPost from "./dialogForm/editPost";
